...
class SpaceJam(ShowBase): #Constructor
    ...
    def SetupScene(self):
        ...
        self.Wanderer1 = spaceJamClasses.Wanderer(self.loader, "./Assets/Drones/JulesVerne.obj", self.render, "Drone1000", 70.0, "./Assets/Drones/Textures/sh3.jpg", self.Player)
